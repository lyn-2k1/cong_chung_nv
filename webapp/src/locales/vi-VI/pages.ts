export default {
  ...
  'pages.login.accountLogin.errorMessage': 'Không đúng email/password(sadmin@gmail.com/admin123)',
  'pages.login.failure': 'Đăng nhập không thành công, vui lòng đăng nhập lại!',
  'pages.login.success': 'Đăng nhập thành công!',
  'pages.login.username.placeholder': 'email: admin or user',
