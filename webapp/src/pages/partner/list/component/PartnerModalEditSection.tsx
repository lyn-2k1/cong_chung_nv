...
import type { IBranch, PartnerCreateRequest, PartnerUpdateRequest } from '@/types';
...
type Props = {
  ...
  handleUpdate: (_data: PartnerCreateRequest | PartnerUpdateRequest) => void;
};

const PartnerModalSection = ({ visible, _onCancel, handleUpdate, changeData, isCreate }: Props) => {
  ...
  return (
    <Modal
      ...
      destroyOnClose
      title={isCreate ? 'THÊM MỚI THÔNG TIN ĐỐI TÁC' : 'SỬA THÔNG TIN ĐỐI TÁC'}
      visible={visible}
      footer={[
...
export default PartnerModalSection;
